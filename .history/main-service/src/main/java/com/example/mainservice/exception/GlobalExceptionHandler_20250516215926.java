...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleWebClientException(WebClientException ex) {
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(
            Map.of(
                "error", "Currency rate service is temporarily unavailable. Please try again later.",
                "error_code", "RATE_SERVICE_UNAVAILABLE"
            )
        );
    }
    ...
    public ResponseEntity<Map<String, String>> handleAuthenticationException(AuthenticationException ex) {
        ...
        response.put("error", "Authentication failed. Please check your credentials or token.");
